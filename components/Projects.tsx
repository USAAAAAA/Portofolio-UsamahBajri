...
const projects = [
  {
    ...
    description:
      "Menguji fungsionalitas dan performa website SISTA, menyusun laporan hasil uji, serta membuat dokumentasi BRD untuk kebutuhan sistem.",
  ...
  },
  {
    ...
    description:
      "Membangun platform informasi sekolah menggunakan framework Laravel serta mendesain antarmuka menggunakan Figma dan Draw.io.",
  ...
  },
  {
    ...
    description:
      "Mengembangkan sistem rekomendasi berdasarkan pola rating pengguna menggunakan Python dan metode Collaborative Filtering.",
...
export default function Projects() {
  return (
    <section
      id="projects"
      className="relative z-30 bg-[#05070A] py-32 px-6 md:px-12 lg:px-24 border-t border-white/5"
    >
      <div className="container mx-auto">
        <div className="mb-24">
          <h2 className="text-yellow-500 font-medium tracking-[0.2em] mb-4 uppercase text-xs">
            Selected Works
          </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-5">
                  <div className="flex items-baseline gap-6 mb-6">
                    <span className="text-gray-600 font-bold text-xl uppercase tracking-tighter">
                      0{index + 1}
                    </span>
                ...
                <div className="lg:col-span-3">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tags.map((tag, i) => (
                      <span
                        key={i}
                        className="text-[9px] px-3 py-1 bg-white/5 border border-white/10 rounded-full text-gray-500 uppercase font-bold"
                      >
                        {tag}
                      </span>
                    ))}
                ...
                <div className={`lg:col-span-4 grid ${project.layout === "grid" ? "grid-cols-2 gap-4" : "grid-cols-1 gap-1"}`}>
                  <div
                    className={`relative rounded-2xl overflow-hidden border border-white/5 shadow-2xl 
    ${project.layout === "grid" ? "aspect-3/4" : "aspect-8/4"}`}
                  >
                    <Image
